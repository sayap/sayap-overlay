...
OPENRESTY_SET_MISC_MODULE_PV="0.29"
...
OPENRESTY_DRIZZLE_MODULE_PV="0.1.9"
...
OPENRESTY_POSTGRES_MODULE_PV="1.0rc6"
...
OPENRESTY_RDS_CSV_MODULE_PV="0.06"
...
OPENRESTY_RDS_JSON_MODULE_PV="0.14"
...
src_prepare() {
	...
	#	epatch "${FILESDIR}"/check_1.7.5+.patch
	#fi

	if use nginx_modules_openresty_postgres; then
		pushd "${OPENRESTY_POSTGRES_MODULE_WD}"
		epatch "${FILESDIR}"/postgres_1.9.1+.patch
		popd
	fi
